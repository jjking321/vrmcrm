...
import { ChevronRight, Phone, Mail, Building, DollarSign, ArrowUpDown, ArrowUp, ArrowDown, AlertTriangle, Users, Loader2, Search, X } from 'lucide-react';
        ...
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-semibold text-foreground">
            {isLoading ? (
              ...
              <span>{owners.length.toLocaleString()} of {totalOwnerCount.toLocaleString()} Owners</span>
            ) : (
